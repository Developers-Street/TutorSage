...
export const meSignupAction = (data: User) => ({ type: ME_SIGNUP, payload: data });
...
export const meSaveDetailsAction = (data: UserData) => ({ type: ME_SAVE_DATA, payload: data });
...
export const meUpdateAction = (data: UserData) => ({ type: ME_UPDATE, payload: data });